...
from model_CFVAE_C_tc import VAE_model, reparam, KL, Discriminator
...
def run_CFVAE_C_tc():
    ...
    for train_n in range(config.train_num):
        ...
        for epoch_number in range(config.train_epochs):
            ...
            for (data, label) in train_loader:
                ...
                if config.model_name == 'VAE': # Original version of VAE
                    ...
                    loss = kl_loss + reconst_loss_x + reconst_loss_a + 10*vae_tc_loss
        ...
        torch.save(model, './model/CFAVE_C_tc')
